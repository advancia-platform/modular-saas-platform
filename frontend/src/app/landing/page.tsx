        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Trade crypto, manage wealth, and grow your portfolio with the most trusted platform.
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-300 mb-4">
              Try Advancia risk-free. If you&apos;re not 100% satisfied within 30 days, we&apos;ll
              refund your entire deposit. No questions. No hassle. Just your money back.
            </p>
