...
export default function SettingsPage() {
  ...
  const handleUpdateBalance = async (userId: string) => {
    try {
      const response = await fetch(`http://localhost:4000/api/users/fund/${userId}`, {
        method: 'POST',
        headers: {
  ...
  const handleUpdateRole = async (userId: string) => {
    try {
      const response = await fetch(`http://localhost:4000/api/users/update-role/${userId}`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
        ...
        <div className="max-w-7xl mx-auto">
          <div className="mb-8">
            ...
            <p className="text-gray-600">
              {isAdmin ? 'Manage users and system settings' : 'Manage your account settings'}
            </p>
          </div>
                ...
                <div className="p-6 space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs text-gray-500">Get notified about account security</p>
                    </div>
                    <label className="relative inline-flex items-center cursor-pointer">
                      <input type="checkbox" className="sr-only peer" defaultChecked />
                      <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
                ...
                <div className="flex">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="mt-1 text-sm text-blue-700">
                      For advanced account management, contact an administrator. Balance updates and
              ...
              <div className="mt-8 bg-blue-50 border border-blue-200 rounded-lg p-4">
                <div className="flex">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="mt-1 text-sm text-blue-700">
                      You can edit user balances directly. Changes will be reflected immediately in
                      the system.
                    </p>
                  </div>
                </div>
