...
```json
{
  "recommendations": ["prisma.prisma", "Vue.volar", "dbaeumer.vscode-eslint", "esbenp.prettier-vscode", "humao.rest-client", "rangav.vscode-thunder-client", "ckolkman.vscode-postgres", "GitHub.copilot", "mhutchie.git-graph", "bradlc.vscode-tailwindcss", "eamodio.gitlens", "formulahendry.auto-rename-tag", "aaron-bond.better-comments"]
}
```
...
_For: -modular-saas-platform project_  
